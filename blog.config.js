...
const BLOG = {
  ...
  AUTHOR: 'Reguluz', // 作者
  BIO: '技术美术|音乐制作 INFP自闭人', // 作者简介
  LINK: 'https://reguluz.site', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'reguluz14@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/reguluz14', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/reguluz', // 你的github个人主页
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2815525558', // 对应歌单的 id
